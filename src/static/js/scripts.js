...
function agregarEquipos(listaTecnicos){        
    ...
    cel2.innerHTML = `<input type="text" name="nombreEquipo`+ cantidadEquipos.value +`" id="nombreEquipo" placeholder="Nombre Equipo" required></input>`;
    ...
    cel5.innerHTML = `<label for="presupuestoEquipo" >Presupuesto Equipo:</label>\n<input type="number" name="presupuestoEquipo" id="presupuestoEquipo`+ cantidadEquipos.value +`" placeholder="Presupuesto" required>`;
    tr.appendChild(cel1);        
    tr.appendChild(cel2);
    tr.appendChild(cel3);
    tr.appendChild(cel4);
